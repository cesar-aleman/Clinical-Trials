...
Oracle Database Management System PL/SQL Components
4.1 Oracle PL/SQL
...
Merged Relation Approach: This simply brings in both R1 and R2 into one
relation.
Foreign Key Approach: Here the primary key of R1 is made into a foreign key of
...
Cross-Reference Approach: In this approach, a new relation is created. This new
...
Foreign Key Approach: Same as the 1:1 cardinality, however, the foreign key and
the attributes must all come from R2. This is so because R2 can only be related to
one instance of R1.
Cross-Reference Approach: Once again this is the same as the 1:1 cardinality,
...
Multiple Relations w/ Superclass & Subclass : Here two relations are needed. One
...
key.
Multiple Relations w/ Subclass: With this approach, subclass entities are given
...
Single Relation w/ One attribute: Only one relation is created and the attributes
...
Multiple Relations w/ Superclass & Subclass: Same exact approach as “isA”
relationship
Multiple Relations w/ Subclass: With this approach, subclass entities are given
their own relation. These relations contain a union of the attributes of the
...
Foreign Key Approach: The relation will simply have a foreign key that will be the
primary key o the relation itself.
Cross-Reference Approach: This approach requires the creation of a new relation.
...
How many doctors are participating in two currently incomplete studies?

What is the least expensive completed/incomplete study?

What studies have at least two assigned activities?

Which doctors have never had an appointment with “John Doe”?

Which doctors have seen at least two patients at an appointment?

List sponsors involved in at least 2 completed studies.

Which subjects have been involved in a study that has been completed?
